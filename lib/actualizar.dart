...
class _Update extends State<actualizar> {
  ...
  void updateData() {
    ...
    if (formkey.currentState.validate()) {
      ...
      if(opcion == null){
        ...
        Student stu = Student(
            currentUserId, valor,  Apellidopaterno,  Apellidomaterno, phone, email, matricula);
        bdHelper.update(stu);
      } else if (opcion == 2) {
        Student stu = Student(
            currentUserId, name, valor,  Apellidomaterno, phone, email, matricula);
        bdHelper.update(stu);
      } else if (opcion == 3) {
        Student stu = Student(
            currentUserId, name,  Apellidopaterno, valor, phone, email, matricula);
        bdHelper.update(stu);
      } else if (opcion == 4) {
        Student stu = Student(
            currentUserId, name,  Apellidopaterno,  Apellidomaterno, valor, email, matricula);
        bdHelper.update(stu);
      } else if (opcion == 5) {
        Student stu = Student(
            currentUserId, name,  Apellidopaterno,  Apellidomaterno, phone, valor, matricula);
        bdHelper.update(stu);
      }
    }
    cleanData();
